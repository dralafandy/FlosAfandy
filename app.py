...
if not st.session_state.logged_in:
    ...
    def load_accounts(user_id):
        return fm.get_all_accounts(user_id)

    @st.cache_data
    def load_transactions(user_id):
        return fm.get_all_transactions(user_id)

    accounts = load_accounts(st.session_state.user_id)
    transactions = load_transactions(st.session_state.user_id)
