...
if not st.session_state.logged_in:
    ...
    with tab1:  # تسجيل الدخول
        ...
        if st.button("تسجيل الدخول"):
            try:
                ...
                st.error("حدث خطأ أثناء تسجيل الدخول. يرجى المحاولة مرة أخرى.")
        ...
        if st.button("تسجيل"):
            if new_password == confirm_password:
                try:
                    ...
                    st.error("حدث خطأ أثناء إنشاء الحساب. يرجى المحاولة مرة أخرى.")
            else:
    ...
    if accounts:
        ...
        if transactions:
            with st.spinner("جاري تحميل المعاملات..."):
